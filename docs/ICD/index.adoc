...
:component-name: Policy Enforcement Point
:component-github-name: um-pep-engine
:doc-title: {component-name} Interface Control Document
:doc-num: {project}.ICD.xxx
:revnumber: 1.0
:revdate: 30/11/2020
:revremark:
:category: Interface Control Document
:copyrightYear: 2020
// attributes
:hardbreaks:
:sectnums:
...
include::03.interfaces/00.interfaces.adoc[]
