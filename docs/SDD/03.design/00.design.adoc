...
|2103
|{"User":user,"Client":client,"Description":"Token validated, forwarding to RM"}

|2104
|{"Ticket":ticket,"Description":"Invalid token, generating ticket for resource:"+resource_id}

|2105
|{"User":user,"Client":client,"Description":"No resource found, forwarding request for path "+path}

|2106
|{"User":user,"Client":client,"Description":"Non-disclosed exception occurred."}

|2007
|{"User":user,"Client":client,"Description":"Returning resource list: "+resource_list}

|2008
|{"User":user,"Client":client,"Description":"No matching resources found for requested path "+path}

|2009
|{"User":user,"Client":client,"Description":"Resource created","Resource_id":resource_id,"Write Policy":write_policy_id,"Read Policy":read_policy_id}

|2010
|{"User":user,"Client":client,"Description":"Error occured: +"error}

|2011
|{"User":user,"Client":client,"Description":"Operation successful","Resource":resource}

|2012
|{"User":user,"Client":client,"Description":"Resource "+resource_id+" deleted"}
