...
=== PEP_UC_001: Self Authentication & Registration
...
=== PEP_UC_003: Resource protection & RPT validation
...
=== PEP_UC_004: Request Forwarding with JWT header
...
=== PEP_UC_005: Resource CRUD operations
...
=== PEP_UC_006: Default protection of resources
...
=== PEP_UC_007: Policy Enforcement Point API
