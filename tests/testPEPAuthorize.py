...
class PEPResourceTest(unittest.TestCase):
    ...
    def createTestResource(self, id_token="filler"):
        payload = {"resource_scopes": [self.scopes], "icon_uri": "/test/" + self.resourceName,
    ...
    def getResourceAuthorize(self, id_token="filler"):
        headers = {'content-type': "application/json", "cache-control": "no-cache",
                   "Authorization": "Bearer " + id_token, "X-Original-Method": "GET",
                   "X-Original-Uri": "/test/" + self.resourceName}
    ...
    def deleteResourceAuthorize(self, token="filler"):
        headers = {'content-type': "application/json", "cache-control": "no-cache", "Authorization": "Bearer " + token,
                   "X-Original-Method": "DELETE", "X-Original-Uri": "/test/" + self.resourceName}
    ...
    def getRPT(self, id_token, ticket):
        ...
        payload = {"claim_token_format": "http://openid.net/specs/openid-connect-core-1_0.html#IDToken",
                   "claim_token": id_token, "ticket": ticket,
                   "grant_type": "urn:ietf:params:oauth:grant-type:uma-ticket", "client_id": self.g_config["client_id"],
                   "client_secret": self.g_config["client_secret"], "scope": 'Authenticated'}
