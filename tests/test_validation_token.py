...
class PEPResourceTest:
    ...
    def createTestResource(self):
        ...
        headers = { 'content-type': "application/json", "cache-control": "no-cache", "Authorization": "Bearer "+self.jwt }
...
if __name__ == '__main__':
    ...
    status, reply = test.getResource(test.jwt)
    if reply["_id"] == test.resourceID and reply["name"] == test.resourceName+"Mod": print("Update resource: Resource properly modified.")
    print("\n")
    print(reply)
    print("=======================")
    print("")